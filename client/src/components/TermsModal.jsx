    ...
    <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="cyber-card max-w-lg w-full animate-slide-up">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary-900/30 border border-primary-700 mb-4">
            <Shield className="w-8 h-8 text-primary-500" />
          </div>
          <h2 className="text-2xl font-bold glow-text mb-2">Welcome to DOOT</h2>
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 terminal-btn-secondary flex items-center justify-center gap-2"
          >
            <X className="w-4 h-4" />
            Decline
          </button>
          <button
            ...
            className="flex-1 terminal-btn flex items-center justify-center gap-2"
          >

...
export default function ChatView() {
  ...
  return (
    <div className="h-screen h-[100dvh] flex flex-col bg-cyber-dark">
      {/* Header */}
      <header className="flex-shrink-0 bg-cyber-darker border-b border-primary-900 px-2 sm:px-4 py-2 sm:py-3 safe-top">
        <div className="flex items-center justify-between gap-1 sm:gap-2">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            <button
              onClick={handleBack}
              className="p-1.5 sm:p-2 hover:bg-primary-900/30 rounded-lg transition-colors flex-shrink-0"
            >
            ...
            {currentSession ? (
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  <span className="status-online flex-shrink-0"></span>
                  <span className="font-semibold text-primary-500 text-sm sm:text-base truncate">
              ...
              <span className="font-semibold text-primary-500 text-sm sm:text-base">
                New Session
              </span>
            )}
          </div>
            ...
            {currentSession && (
              <>
                <button
                  ...
                  className="p-1.5 sm:p-2 hover:bg-primary-900/30 rounded-lg transition-colors"
                  title="Audio Call"
                >
              ...
              <div className="relative">
                ...
                {showMenu && (
                  <>
                    ...
                    />
                    <div className="absolute right-0 top-full mt-2 w-44 sm:w-48 bg-cyber-darker border border-primary-900 rounded-lg shadow-xl z-20 overflow-hidden">
                      <button
                        onClick={handleClearHistory}
                        className="w-full flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2.5 sm:py-3 text-sm text-primary-600 hover:bg-primary-900/30 transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2.5 sm:py-3 text-sm text-red-500 hover:bg-red-900/30 transition-colors"
                      >
                        <X className="w-4 h-4" />
                        End Session
                      </button>
        ...
        <div className="flex-1 flex items-center justify-center px-3 py-4 sm:p-4">
          <div className="cyber-card w-full max-w-md animate-fade-in">
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-primary-900/30 flex items-center justify-center flex-shrink-0">
                <Users className="w-5 h-5 text-primary-500" />
              </div>
              <div className="min-w-0">
                <h2 className="font-semibold text-primary-500 text-sm sm:text-base">
      ...
      {!showSessionSetup && currentSession && (
        <>
          {/* Messages */}
          <div className="flex-1 overflow-y-auto px-2 py-3 sm:p-4 space-y-3 scrollbar-hide">
            {messages.length === 0 && (
          ...
          {/* Input Area */}
          <div className="flex-shrink-0 bg-cyber-darker border-t border-primary-900 p-2 sm:p-3 safe-bottom">
            <form
            ...
            >
              <button
                ...
                className="p-2 sm:p-3 hover:bg-primary-900/30 rounded-lg transition-colors flex-shrink-0"
              >
              ...
              <input
                ...
                className="flex-1 min-w-0 terminal-input py-2.5 sm:py-3"
              />

              <button
                type="submit"
                disabled={!message.trim()}
                className="p-2 sm:p-3 bg-primary-500 hover:bg-primary-400 disabled:bg-primary-900 disabled:text-primary-700 rounded-lg transition-colors flex-shrink-0"
              >
